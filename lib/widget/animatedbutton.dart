...
class AnimatedButton extends StatefulWidget {
  ...
  final mButtonStyle buttonStyle;
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          child: DottedBorder(
            strokeWidth: 2,
            color:  _currentState == ButtonState.SHOW_TEXT_ICON?Colors.black87:Color(0xff02ab94) ,
            ...
            child: AnimatedSize(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  SizedBox(
                    width:
                        _currentState == ButtonState.SHOW_TEXT_ICON ? 32.0 : 0.0,
                  ),
                  getTextWidget()
                ],
              ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(shape: BoxShape.rectangle,color: Colors.white),
              child: Text(
                widget.finalText.isNotEmpty? widget.finalText[0]+widget.finalText[1]:"em",
